...
class A2Topology( Topo ):
    ...
    def build( self ):
        ...
        self.addLink( s1, s3, bw=0.3, jitter='3ms', loss=2, ) # poor bw = 100kbps (min) per user (voice)
        self.addLink( s1, s4, bw=3 , jitter='0.5ms', loss=0.5,) # low bw = 1Mbps per user (datanetwork)
